...
function updateMuscles(muscleGroup){
  ...
  return (
    ...
    description={'Select the muscles juged for annihilation  '}/>
    <div className='bg-slate-950  border border-solid border-blue-400 rounded-lg flex flex-col'>
      <button onClick={toggleModel} className='relative   py-3 flex items-center justify-center'>
        <p className='capitalize'>{ muscles.length==0?'Select muscels group':muscles.join(' ')}</p>
    ...
    <Header index={'03'} title={'Become a Titan'} description={'Select your ultimate objective'}/>
